...
namespace TourManagement
{
    ...
    partial void DeleteThamQuan(ThamQuan instance);
		...
		public TourManagementDataContext() : 
				base(global::TourManagement.Properties.Settings.Default.tourmanagementConnectionString2, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnLoaiChiPhi_IdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DoanDuLich_ChiPhi", Storage="_DoanDuLich", ThisKey="DoanDuLich_Id", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnLoaiTour_IdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="LoaiTour_Tour", Storage="_LoaiTour", ThisKey="LoaiTour_Id", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnDoanDuLich_IdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DoanDuLich_ChiTietDoan", Storage="_DoanDuLich", ThisKey="DoanDuLich_Id", OtherKey="Id", IsForeignKey=true)]
		public DoanDuLich DoanDuLich
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="KhachHang_ChiTietDoan", Storage="_KhachHang", ThisKey="KhachHang_Id", OtherKey="Id", IsForeignKey=true)]
	...
	public partial class DiaDiem : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<NoiDungTour> _NoiDungTours;
    ...
    partial void OnTenDiaDiemChanged();
		...
		public DiaDiem()
		{
			this._NoiDungTours = new EntitySet<NoiDungTour>(new Action<NoiDungTour>(this.attach_NoiDungTours), new Action<NoiDungTour>(this.detach_NoiDungTours));
			this._ThamQuans = new EntitySet<ThamQuan>(new Action<ThamQuan>(this.attach_ThamQuans), new Action<ThamQuan>(this.detach_ThamQuans));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DiaDiem_NoiDungTour", Storage="_NoiDungTours", ThisKey="Id", OtherKey="DiaDiem_Id")]
		public EntitySet<NoiDungTour> NoiDungTours
		{
			get
			{
				return this._NoiDungTours;
			}
			set
			{
				this._NoiDungTours.Assign(value);
			}
		}
		...
		private void attach_NoiDungTours(NoiDungTour entity)
		{
			this.SendPropertyChanging();
			entity.DiaDiem = this;
		}
		
		private void detach_NoiDungTours(NoiDungTour entity)
		{
			this.SendPropertyChanging();
			entity.DiaDiem = null;
		}
    ...
    partial void OnDoanhThuChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Tour_DoanDuLich", Storage="_Tour", ThisKey="Tour_Id", OtherKey="Id", IsForeignKey=true)]
		public Tour Tour
		{
			get
			{
    ...
    partial void OnDiaDiem_IdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_KhachSan", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DiaDiem_Id", DbType="Int NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DiaDiem_NoiDungTour", Storage="_DiaDiem", ThisKey="DiaDiem_Id", OtherKey="Id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._DiaDiem.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.NoiDungTours.Remove(this);
					}
					this._DiaDiem.Entity = value;
					if ((value != null))
					{
						value.NoiDungTours.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DoanDuLich_NoiDungTour", Storage="_DoanDuLich", ThisKey="DoanDuLich_Id", OtherKey="Id", IsForeignKey=true)]
		public DoanDuLich DoanDuLich
		{
			get
			{
    ...
    partial void OnNhiemVuChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DoanDuLich_PhanCong", Storage="_DoanDuLich", ThisKey="DoanDuLich_Id", OtherKey="Id", IsForeignKey=true)]
		public DoanDuLich DoanDuLich
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhanVien_PhanCong", Storage="_NhanVien", ThisKey="NhanVien_Id", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnThuTuChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DiaDiem_ThamQuan", Storage="_DiaDiem", ThisKey="DiaDiem_Id", OtherKey="Id", IsForeignKey=true)]
		public DiaDiem DiaDiem
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Tour_ThamQuan", Storage="_Tour", ThisKey="Tour_Id", OtherKey="Id", IsForeignKey=true)]
		public Tour Tour
		{
			get
			{
